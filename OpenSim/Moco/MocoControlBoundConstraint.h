...
class OSIMMOCO_API MocoControlBoundConstraintFunctionGroup : public Object {
    OpenSim_DECLARE_CONCRETE_OBJECT(
            MocoControlBoundConstraintFunctionGroup, Object);
...
public:
    ...
    void addFunctionGroup(MocoControlBoundConstraintFunctionGroup group) {
        append_function_groups(std::move(group));
    }
...
private:
    OpenSim_DECLARE_LIST_PROPERTY(
            function_groups, MocoControlBoundConstraintFunctionGroup,
            "TODO.");
    //OpenSim_DECLARE_LIST_PROPERTY(control_paths, std::string,
    //        "Constrain the control signal of the actuators specified by these "
    //        "paths.");
    ...
    struct GroupInfo {
        mutable bool hasLower;
        mutable bool hasUpper;
        mutable bool equalityWithLower;
        const Function* lowerBound;
        const Function* upperBound;
        mutable std::vector<int> controlIndices;
    };
